...
public class TestInternationalUnionOfCrystallographyJenaMetadataExtractor extends LockssTestCase {

	public void testJenaExtract() {
		...
		try {
			new InternationalUnionOfCrystallographyJenaMetadataExtractor().extract(au, dbManager);
		} catch (IOException e) {
