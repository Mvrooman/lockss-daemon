...
public class MongoMetadataManager extends MetadataManager {
	...
	/**
	 * Find a publisher given the name of a Publisher.
	 * @param publisher The name of the publisher.
	 * @return Long The longId of the Publisher
	 */
	...
	/**
	 * Add a publisher with the given name.
	 * @param publisher The name to give to the publisher.
	 * @return Long The longId of the Publisher
	 */
